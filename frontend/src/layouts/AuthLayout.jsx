...
export default function AuthLayout({ children }) {
  ...
  return (
    <div className="h-screen max-h-screen w-full overflow-hidden bg-slate-950 flex items-center justify-center p-3 sm:p-4 lg:p-6 selection:bg-teal-500 selection:text-white relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <motion.div 
          ...
          className="absolute -top-[15%] -left-[10%] w-[550px] h-[550px] rounded-full bg-teal-600/20 blur-[130px]"
        />
        <motion.div 
          animate={{
            x: [0, -50, 30, 0],
          ...
          className="absolute -bottom-[15%] -right-[10%] w-[550px] h-[550px] rounded-full bg-emerald-600/20 blur-[130px]"
        />
        <motion.div 
          animate={{ 
            x: [0, 30, -30, 0], 
          ...
          className="absolute top-[35%] left-[25%] w-[400px] h-[400px] rounded-full bg-indigo-600/15 blur-[110px]"
        />
      </div>
      ...
      <div className="container relative z-10 mx-auto w-full max-w-6xl flex items-center justify-center my-auto">
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
          
          {/* Left Branding Hero Banner (Desktop) */}
          <div className="lg:col-span-6 flex flex-col justify-center text-white space-y-4 lg:pr-4">
            ...
            <div className="space-y-1.5">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black leading-tight tracking-tight text-white">
                Precision Obesity Care & <br className="hidden sm:block" />
            ...
            {/* AI Clinical Pipeline Metrics Box (Exact Verified Random Forest Outputs) */}
      ...
      <div className="absolute bottom-2 left-0 right-0 text-center text-[10px] text-slate-400 font-mono tracking-wider uppercase pointer-events-none z-10 hidden sm:block">
        © 2026 SmartObesity AI • Clinical Decision Support & Diet Prescriptions
      </div>
