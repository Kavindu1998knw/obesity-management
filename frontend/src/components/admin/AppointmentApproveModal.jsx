    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
          <h3 className="text-lg font-bold text-slate-900">Approve Appointment</h3>
        ...
        <div className="p-6">
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 mb-4">
            <p className="text-sm text-blue-800 font-medium mb-2">Please confirm appointment details:</p>
          ...
          <form id="approve-form" onSubmit={handleSubmit}>
            <div>
              ...
              <textarea 
                ...
                placeholder="Any specific instructions for the doctor or clinic staff..." 
              />
            </div>
          </form>
        </div>
        ...
        <div className="px-6 py-4 bg-slate-50 border-t border-slate-200 flex justify-end gap-3">
          ...
          <button type="submit" form="approve-form" disabled={loading} className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700">
